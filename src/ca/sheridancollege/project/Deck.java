...
/**
 * Deck class defines standard 52-card deck to be used for War Card Game
 * The deck size is stored in final for flexibility allowing different sized decks for different applications
 * @author AhmadBustani
